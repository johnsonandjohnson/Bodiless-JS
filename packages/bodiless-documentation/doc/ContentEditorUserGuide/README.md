...
Click the **"Page"** button in the Toolbar to open the _Page_ submenu.

**Review Mode**  
![Page submenu in Review Mode](./assets/PageSubmenuReviewMode.jpg ':size=50%')

**Edit Mode**  
![Page submenu in Edit Mode](./assets/PageSubmenuEditMode.jpg ':size=50%')

In the _Page_ submenu, you will find the following items:

* [New](#new)
* [Disable](#disable) (Edit Mode only)
* GTM (Edit Mode only)
* [SEO](#seo-metadata) (Edit Mode only)
* Share (Edit Mode only)

##### New

![New Page icon](./assets/PageNewIcon.jpg)

Click the **"New"** button to create a new page for your site.

When you click the "New" button, you will be prompted to enter the URL you wish to use for the new
page.
...
[templates](../../../Development/Guides/BuildingSites/Templates/?id=templates-overview). Developers
use templates to define page layout to maintain uniformity and consistency across content types and
sections.

A page is added to the section in which it was created. The newly created page will use the
[template](../../../Development/Guides/BuildingSites/Templates/?id=templates-overview) associated
with that section.

##### Disable

![Disable icon](./assets/PageDisableIcon.jpg)

Using the **"Disable"** button, you can disable various features of the current page.
...
02. Select the checkbox of each feature that you would like to disable.
...
03. Click the checkmark in the bottom-right of the submenu to apply your selection.
...
04. Click the "X" icon to close the submenu.
