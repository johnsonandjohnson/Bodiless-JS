...
This section describes how to build a site using BodilessJS and the Vital Design System. While
this guide specifically uses Vital design system, building out custom tokens and components —
instead of utilizing those offered by VitalDS — will work.
...
01. Text Editors:  
    ...
    01. For an step-by-step overview of using, extending or overriding the editors, see [VitalDS
...
01. Basic Layout / Page:  
    ...
    For a more in-depth guide on working with the layout, please visit [VitalDS
    Layout](/Vital_DesignSystem/Components/Vital_Layout/).
